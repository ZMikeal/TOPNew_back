...
<table>
 <?php if(is_array($groups_list)): $i = 0; $__LIST__ = $groups_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
<td>用户名：<?php echo ($vo["user"]); ?></td>
<td></td>
